        ...
        $(document).ready(function() {
            ...
            $('#post').DataTable({
                ...
                columns: [
                    ...
                    {data: 'post_types', name: 'post_types'},
                    {data: 'user', name: 'user'},
...
{{--                    <h4 class="card-title">@lang('post::lang.post')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('post::lang.post')</h4>
                @if(auth()->user()->can('post_import'))
{{--                    <a href="{{ route('post.import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('post::lang.post_import')</a>--}}
                @endif
                @if(auth()->user()->can('post_create'))
                    <a href="{{ route('post.create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('post::lang.post_create')</a>
                @endif
            </div>
            <div class="card-body"><i class="icon icon-app-store"></i>
                <div class="table-responsive">
                    <table id="post" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
