...
{{--                    <h4 class="card-title">@lang('posttype::lang.posttype')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                @if(auth()->user()->can('posttype_import'))
{{--                    <a href="{{ route('posttype.import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('post::lang.posttype_import')</a>--}}
                @endif
                @if(auth()->user()->can('posttype_create'))
{{--                    <a href="{{ route('posttype.create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('post::lang.posttype_create')</a>--}}
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="posttype" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
