...
{{--                    <h4 class="card-title">@lang('page::lang.page')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('post::lang.page')</h4>
                @if(auth()->user()->can('page_import'))
{{--                    <a href="{{ route('post.page.import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('post::lang.page_import')</a>--}}
                @endif
                @if(auth()->user()->can('page_create'))
                    <a href="{{ route('page.create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('post::lang.page_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="page" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
                            ...
                            <th>@lang('post::lang.templates')</th>
