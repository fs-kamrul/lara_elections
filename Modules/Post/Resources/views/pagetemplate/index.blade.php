    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#pagetemplate').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('post/api/pagetemplate') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('pagetemplate::lang.pagetemplate')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('post::lang.pagetemplate')</h4>
                @if(auth()->user()->can('pagetemplate_import'))
{{--                    <a href="{{ route('pagetemplate.import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('post::lang.pagetemplate_import')</a>--}}
                @endif
                @if(auth()->user()->can('pagetemplate_create'))
{{--                    <a href="{{ route('pagetemplate.create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('post::lang.pagetemplate_create')</a>--}}
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="pagetemplate" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
