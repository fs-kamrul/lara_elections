...
class InstallController  extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->appVersion = config('post.module_version');
        $this->appType = config('post.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Post"]);
            Artisan::call('module:seed', ['module' => "Post"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Post module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Post module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
