<div class="col-lg-7 mb-2">
    ...
    @else
        <div class="h-100 d-flex align-items-center justify-content-center bg-light">
            <div>{{ trans('kamruldashboard::lang.no_data') }}</div>
        </div>
    @endif
</div>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('analytics::lang.sessions') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('analytics::lang.visitors') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box border-green-haze">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('analytics::lang.pageviews') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('analytics::lang.bounce_rate') }}</span>
...
{{--        </div>--}}
{{--        <div class="info-box-content">--}}
{{--            <span class="info-box-text">{{ trans('analytics::lang.percent_new_session') }}</span>--}}
...
{{--        </div>--}}
{{--        <div class="info-box-content">--}}
{{--            <span class="info-box-text">{{ trans('analytics::lang.page_session') }}</span>--}}
...
{{--        </div>--}}
{{--        <div class="info-box-content">--}}
{{--            <span class="info-box-text">{{ trans('analytics::lang.avg_duration') }}</span>--}}
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('analytics::lang.new_users') }}</span>
...
<div data-lang-pageviews='{{ trans("analytics::lang.pageviews") }}'></div>
<div data-lang-visits='{{ trans("analytics::lang.visitors") }}'></div>
