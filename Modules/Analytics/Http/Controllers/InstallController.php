...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'Analytics';
        $this->appVersion = config('analytics.module_version');
        $this->appType = config('analytics.module_type');
    ...
    public function index()
    {
        ...
        $output = ['status' => 1,
                    'message' => 'Analytics module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    private function installSettings()
    {
        ...
        Artisan::call('module:seed', ['module' => "Analytics"]);
        Artisan::call('module:enable', ['module' => "Analytics"]);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Analytics module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Analytics"]);
            Artisan::call('optimize');
