            ...
            <tr>
                ...
                <td class="translation-column">
                    <div class="ui-select-wrapper">
                        <select name="language" id="post_lang_choice" class="ui-select form-control">
...
@if (count($languages) > 1)
    <div><strong>{{ trans('language::lang.translations') }}</strong>
        <div id="list-others-language">
            @foreach($languages as $language)
                @if ($language->lang_code != $currentLanguage->lang_code)
                    ...
                    @else
                        @php
                            $currentQueryString = DboardHelper::removeQueryStringVars(Request::getQueryString(), ['ref_from', 'ref_lang']);
    ...
    {!! Form::modalAction('confirm-change-language-modal', trans('language::lang.confirm-change-language'), 'warning', trans('language::lang.confirm-change-language-message'), 'confirm-change-language-button', trans('language::lang.confirm-change-language-btn')) !!}
@endif
