...
class LanguageMeta extends DboardModel
{
     ...
     */
    public static function saveMetaData(DboardModel $model, ?string $locale = null, ?string $originValue = null)
    {
        if (!$locale) {
