...
class InstallController  extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->appVersion = config('language.module_version');
        $this->appType = config('language.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Language"]);
            Artisan::call('module:seed', ['module' => "Language"]);
            Artisan::call('module:enable', ['module' => "Language"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Language module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Language module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Language"]);
            Artisan::call('optimize');
