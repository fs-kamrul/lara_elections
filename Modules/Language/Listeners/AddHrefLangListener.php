            ...
            if (defined('THEME_FRONT_HEADER')) {
                add_filter(THEME_FRONT_HEADER, function ($header) use ($event) {
                    ...
                    if (in_array($event->slug->reference_type, Language::supportedModels())) {
                        if ($event->slug->reference_type == Page::class && DboardHelper::isHomepage($event->slug->reference_id)) {
                    ...
                    return $header . view('language::partials.hreflang', compact('urls'))->render();
                }, 55);
            }
