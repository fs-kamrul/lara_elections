(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: dt => {
            return '<i class="fa fa-file-excel-o"></i> ' + dt.i18n('buttons.excel', KamrulVariables.languages.tables.excel ? KamrulVariables.languages.tables.excel : 'Excel');
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: dt => {
            return '<i class="fa fa-file-o"></i> ' + dt.i18n('buttons.csv', KamrulVariables.languages.tables.csv ? KamrulVariables.languages.tables.csv : 'CSV');
        },
