...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'Table';
        $this->appVersion = config('table.module_version');
        $this->appType = config('table.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Table"]);
            Artisan::call('module:seed', ['module' => "Table"]);
            Artisan::call('module:enable', ['module' => "Table"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Table module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Table module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Table"]);
            Artisan::call('optimize');
