...
class TableController extends Controller
{
     ...
     */
    public function postSaveBulkChange(Request $request, DboardHttpResponse $response)
    {
        $ids = $request->input('ids');
        if (empty($ids)) {
            return $response
                ->setError()
                ->setMessage(trans('table::lang.please_select_record'));
        }
        ...
        return $response->setMessage(trans('table::lang.save_bulk_change_success'));
    }
