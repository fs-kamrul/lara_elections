...
class InstallController  extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->appVersion = config('faq.module_version');
        $this->appType = config('faq.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Faq"]);
            Artisan::call('module:seed', ['module' => "Faq"]);
            Artisan::call('module:enable', ['module' => "Faq"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Faq module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Faq module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Faq"]);
            Artisan::call('optimize');
