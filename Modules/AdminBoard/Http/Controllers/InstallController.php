...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'AdminBoard';
        $this->appVersion = config('adminboard.module_version');
        $this->appType = config('adminboard.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "AdminBoard"]);
            Artisan::call('module:seed', ['module' => "AdminBoard"]);
            Artisan::call('module:enable', ['module' => "AdminBoard"]);
        ...
        $output = ['status' => 1,
                    'message' => 'AdminBoard module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'AdminBoard module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "AdminBoard"]);
            Artisan::call('optimize');
