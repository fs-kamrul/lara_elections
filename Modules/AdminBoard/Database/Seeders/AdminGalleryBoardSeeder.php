...
class AdminGalleryBoardSeeder extends Seeder
{
    /**
...
//                'location' => $location,
            ...
            $data_slug[] = [
                'key'               => $slug,
                'reference_id'      => $i,
                'reference_type'    => AdminGalleryBoard::class,
                'prefix'            => SlugHelper::getPrefix(AdminGalleryBoard::class),
            ];
        }
        Slug::where('reference_type',AdminGalleryBoard::class)->delete();
//        SlugInterface::
//        print_r($data_slug);
        AdminGalleryBoard::upsert($data, ['name']);
