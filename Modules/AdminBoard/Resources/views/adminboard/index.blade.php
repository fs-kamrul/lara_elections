...
{{--                    <h4 class="card-title">@lang('adminboard::lang.adminboard')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
        ...
        <div class="card">
            <div class="card-header">
                ...
                @if(auth()->user()->can('adminboard_import'))
                    <a href="{{ url('adminboard/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminboard_import')</a>
                @endif
                @if(auth()->user()->can('adminboard_create'))
                    <a href="{{ route('adminboard.create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminboard_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminboard" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
