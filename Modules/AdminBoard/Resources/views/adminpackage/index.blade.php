    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminpackage').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminpackage') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminpackage::lang.adminpackage')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminpackage')</h4>
                @if(auth()->user()->can('adminpackage_import'))
                    <a href="{{ url('adminboard/adminpackage/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminpackage_import')</a>
                @endif
                @if(auth()->user()->can('adminpackage_create'))
                    <a href="{{ url('adminboard/adminpackage/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminpackage_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminpackage" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
