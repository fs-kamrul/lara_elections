    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#admineducation').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/admineducation') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('admineducation::lang.admineducation')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.admineducation')</h4>
                @if(auth()->user()->can('admineducation_import'))
                    <a href="{{ url('adminboard/admineducation/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.admineducation_import')</a>
                @endif
                @if(auth()->user()->can('admineducation_create'))
                    <a href="{{ url('adminboard/admineducation/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.admineducation_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="admineducation" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
