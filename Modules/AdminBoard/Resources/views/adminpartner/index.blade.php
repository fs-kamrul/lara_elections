    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminpartner').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminpartner') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminpartner::lang.adminpartner')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminpartner')</h4>
                @if(auth()->user()->can('adminpartner_import'))
                    <a href="{{ url('adminboard/adminpartner/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminpartner_import')</a>
                @endif
                @if(auth()->user()->can('adminpartner_create'))
                    <a href="{{ url('adminboard/adminpartner/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminpartner_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminpartner" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
