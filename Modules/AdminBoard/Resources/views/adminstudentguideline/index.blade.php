...
@section('javascript')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminstudentguideline').DataTable({
                pageLength: 10,
                dom: 'lBfrtip<"actions">',
                buttons: [
                    // {
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminstudentguideline') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminstudentguideline::lang.adminstudentguideline')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminstudentguideline')</h4>
                @if(auth()->user()->can('adminstudentguideline_import'))
                    <a href="{{ url('adminboard/adminstudentguideline/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminstudentguideline_import')</a>
                @endif
                @if(auth()->user()->can('adminstudentguideline_create'))
                    <a href="{{ url('adminboard/adminstudentguideline/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminstudentguideline_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminstudentguideline" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
