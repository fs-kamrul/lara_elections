    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminftpserver').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminftpserver') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminftpserver::lang.adminftpserver')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminftpserver')</h4>
                @if(auth()->user()->can('adminftpserver_import'))
                    <a href="{{ url('adminboard/adminftpserver/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminftpserver_import')</a>
                @endif
                @if(auth()->user()->can('adminftpserver_create'))
                    <a href="{{ url('adminboard/adminftpserver/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminftpserver_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminftpserver" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
