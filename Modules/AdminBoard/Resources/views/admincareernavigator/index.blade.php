...
@section('javascript')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#admincareernavigator').DataTable({
                pageLength: 10,
                dom: 'lBfrtip<"actions">',
                buttons: [
                    // {
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/admincareernavigator') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('admincareernavigator::lang.admincareernavigator')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.admincareernavigator')</h4>
                @if(auth()->user()->can('admincareernavigator_import'))
                    <a href="{{ url('adminboard/admincareernavigator/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.admincareernavigator_import')</a>
                @endif
                @if(auth()->user()->can('admincareernavigator_create'))
                    <a href="{{ url('adminboard/admincareernavigator/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.admincareernavigator_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="admincareernavigator" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
