    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#admincategory').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/admincategory') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('admincategory::lang.admincategory')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.admincategory')</h4>
                @if(auth()->user()->can('admincategory_import'))
                    <a href="{{ url('adminboard/admincategory/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.admincategory_import')</a>
                @endif
                @if(auth()->user()->can('admincategory_create'))
                    <a href="{{ url('adminboard/admincategory/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.admincategory_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="admincategory" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
