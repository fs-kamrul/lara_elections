    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminnoticeboard').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminnoticeboard') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminnoticeboard::lang.adminnoticeboard')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminnoticeboard')</h4>
                @if(auth()->user()->can('adminnoticeboard_import'))
                    <a href="{{ url('adminboard/adminnoticeboard/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminnoticeboard_import')</a>
                @endif
                @if(auth()->user()->can('adminnoticeboard_create'))
                    <a href="{{ url('adminboard/adminnoticeboard/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminnoticeboard_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminnoticeboard" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
