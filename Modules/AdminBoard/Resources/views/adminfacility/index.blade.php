    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminfacility').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminfacility') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminfacility::lang.adminfacility')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminfacility')</h4>
                @if(auth()->user()->can('adminfacility_import'))
                    <a href="{{ url('adminboard/adminfacility/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminfacility_import')</a>
                @endif
                @if(auth()->user()->can('adminfacility_create'))
                    <a href="{{ url('adminboard/adminfacility/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminfacility_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminfacility" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
