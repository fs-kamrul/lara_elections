    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#admintestimonial').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/admintestimonial') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('admintestimonial::lang.admintestimonial')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.admintestimonial')</h4>
                @if(auth()->user()->can('admintestimonial_import'))
                    <a href="{{ url('adminboard/admintestimonial/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.admintestimonial_import')</a>
                @endif
                @if(auth()->user()->can('admintestimonial_create'))
                    <a href="{{ url('adminboard/admintestimonial/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.admintestimonial_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="admintestimonial" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
