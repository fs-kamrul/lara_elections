                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            ...
                                            @isset($record) @if($language['code_edit']){!! input_design_html('thumbnail',$record,6,'file', __('adminboard::lang.thumbnail')) !!} @endif @else{!! input_design_html('thumbnail',null,6,'file', __('adminboard::lang.thumbnail')) !!} @endisset
                                            {!! Form::textField('youtube_link', isset($record) ? $record->youtube_link : null, 'adminboard', '6', ['placeholder'=> __('adminboard::lang.youtube_link')]) !!}
...
{{--                                            </div>--}}
                        ...
                        <div class=" col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">@lang('adminboard::lang.is_video')</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="basic-form">
                                            ...
                                            <div class="form-row">
                                                <div class="form-check">
                                                    {!! Form::checkbox('is_video', 1, isset($record) ? (bool)$record->is_video : false, ['class' => 'form-check-input', 'id' => 'is_video']) !!}
                                                    <label class="form-check-label" for="is_video">{{ __('adminboard::lang.is_video') }}</label>
                                                </div>

                                                {{--                                                {!! Form::checkbox('is_video', isset($record) ? $record->is_video : 0, 'option', '12', ['placeholder'=> __('option::lang.is_video')]) !!}--}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
