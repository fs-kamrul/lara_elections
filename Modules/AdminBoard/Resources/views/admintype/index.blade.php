    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#admintype').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/admintype') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('admintype::lang.admintype')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.admintype')</h4>
                @if(auth()->user()->can('admintype_import'))
                    <a href="{{ url('adminboard/admintype/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.admintype_import')</a>
                @endif
                @if(auth()->user()->can('admintype_create'))
                    <a href="{{ url('adminboard/admintype/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.admintype_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="admintype" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
