    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminclub').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminclub') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminclub::lang.adminclub')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminclub')</h4>
                @if(auth()->user()->can('adminclub_import'))
                    <a href="{{ url('adminboard/adminclub/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminclub_import')</a>
                @endif
                @if(auth()->user()->can('adminclub_create'))
                    <a href="{{ url('adminboard/adminclub/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminclub_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminclub" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
