    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminevent').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminevent') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminevent::lang.adminevent')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminevent')</h4>
                @if(auth()->user()->can('adminevent_import'))
                    <a href="{{ url('adminboard/adminevent/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminevent_import')</a>
                @endif
                @if(auth()->user()->can('adminevent_create'))
                    <a href="{{ url('adminboard/adminevent/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminevent_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminevent" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
