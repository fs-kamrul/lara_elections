    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminteam').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminteam') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminteam::lang.adminteam')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminteam')</h4>
                @if(auth()->user()->can('adminteam_import'))
                    <a href="{{ url('adminboard/adminteam/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminteam_import')</a>
                @endif
                @if(auth()->user()->can('adminteam_create'))
                    <a href="{{ url('adminboard/adminteam/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminteam_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminteam" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
