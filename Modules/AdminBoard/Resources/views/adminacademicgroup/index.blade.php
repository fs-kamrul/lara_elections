    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminacademicgroup').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminacademicgroup') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminacademicgroup::lang.adminacademicgroup')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminacademicgroup')</h4>
                @if(auth()->user()->can('adminacademicgroup_import'))
                    <a href="{{ url('adminboard/adminacademicgroup/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminacademicgroup_import')</a>
                @endif
                @if(auth()->user()->can('adminacademicgroup_create'))
                    <a href="{{ url('adminboard/adminacademicgroup/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminacademicgroup_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminacademicgroup" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
