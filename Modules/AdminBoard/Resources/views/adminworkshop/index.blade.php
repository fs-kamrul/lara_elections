    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminworkshop').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminworkshop') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminworkshop::lang.adminworkshop')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminworkshop')</h4>
                @if(auth()->user()->can('adminworkshop_import'))
                    <a href="{{ url('adminboard/adminworkshop/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminworkshop_import')</a>
                @endif
                @if(auth()->user()->can('adminworkshop_create'))
                    <a href="{{ url('adminboard/adminworkshop/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminworkshop_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminworkshop" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
