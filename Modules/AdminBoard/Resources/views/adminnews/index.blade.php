    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminnews').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminnews') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminnews::lang.adminnews')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminnews')</h4>
                @if(auth()->user()->can('adminnews_import'))
                    <a href="{{ url('adminboard/adminnews/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminnews_import')</a>
                @endif
                @if(auth()->user()->can('adminnews_create'))
                    <a href="{{ url('adminboard/adminnews/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminnews_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminnews" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
