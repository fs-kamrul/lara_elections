    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#adminservice').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('adminboard/api/adminservice') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('adminservice::lang.adminservice')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('adminboard::lang.adminservice')</h4>
                @if(auth()->user()->can('adminservice_import'))
                    <a href="{{ url('adminboard/adminservice/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('adminboard::lang.adminservice_import')</a>
                @endif
                @if(auth()->user()->can('adminservice_create'))
                    <a href="{{ url('adminboard/adminservice/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('adminboard::lang.adminservice_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="adminservice" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
