                            ...
                            <table>
                                ...
                                <tr>
                                    <td align="left" style="padding: 20px 50px;">
                                        ...
                                        <p><img src="{{ site_url }}/kamruldashboard/images/emails/person.png"
                                                alt="From" width="20" style="margin-right: 10px;" /> {{ consult_name }} ({{ consult_ip_address }})</p>
                                        <p><img src="{{ site_url }}/kamruldashboard/images/emails/email.png"
                                                alt="Email" width="20" style="margin-right: 10px;" /> {{ consult_email }}</p>
                                        <p><img src="{{ site_url }}/kamruldashboard/images/emails/phone.png"
                                        ...
                                        <p><img src="{{ site_url }}/kamruldashboard/images/emails/message.png"
