...
use Modules\AdminBoard\Http\Requests\AdminEducationRequest;
...
class AdminEducationForm extends FormAbstract
{
    public function setup(): void
    {
        $this
            ->setupModel(new AdminEducation())
            ->setValidatorClass(AdminEducationRequest::class)
...
//            ->add('description', EditorField::class, ContentFieldOption::make()->allowedShortcodes()->toArray())
            ...
            ->add('status', SelectField::class, StatusFieldOption::make()->choices(AdminEducationStatusEnum::labels())->toArray())
            ->add('order', 'text', [
