...
use Modules\AdminBoard\Http\Requests\ClubRequest;
...
class ClubForm extends FormAbstract
{
    public function setup(): void
    {
        $this
            ->setupModel(new Club())
            ->setValidatorClass(ClubRequest::class)
...
//                ],
            ...
            ->add('status', SelectField::class, StatusFieldOption::make()->choices(ClubStatusEnum::labels())->toArray())
            ->add('order', 'text', [
