...
class WorkshopForm extends FormAbstract
{
    public function setup(): void
    {
        ...
        $this
            ...
            ->add('start_date', 'date', [
                ...
                'attr' => [
                    'placeholder' => trans('adminboard::lang.start_date'),
//                    'data-counter' => 25,
                ],
            ])
            ->add('set_time', 'text', [
                ...
                'attr' => [
                    'placeholder' => trans('adminboard::lang.set_time'),
//                    'data-counter' => 25,
                ],
            ])
            ->add('location', 'text', [
                ...
                'attr' => [
                    'placeholder' => trans('adminboard::lang.location'),
//                    'data-counter' => 25,
                ],
            ])
...
//                    'data-counter' => 25,educations
            ...
            ->add('categories[]', 'categoryMulti', [
                ...
                'required' => true,
                'choices' => get_teams_with_children('workshop'),
