...
use Modules\AdminBoard\Http\Requests\AdminClubRequest;
...
class AdminClubForm extends FormAbstract
{
    public function setup(): void
    {
        $this
            ->setupModel(new AdminClub())
            ->setValidatorClass(AdminClubRequest::class)
