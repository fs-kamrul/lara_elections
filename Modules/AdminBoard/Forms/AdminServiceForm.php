...
use Modules\AdminBoard\Http\Requests\AdminServiceRequest;
...
class AdminServiceForm extends FormAbstract
{
    public function setup(): void
    {
        $this
            ->setupModel(new AdminService())
            ->setValidatorClass(AdminServiceRequest::class)
...
//                ],
            ...
            ->add('status', SelectField::class, StatusFieldOption::make()->choices(AdminServiceStatusEnum::labels())->toArray())
            ->add('order', 'text', [
