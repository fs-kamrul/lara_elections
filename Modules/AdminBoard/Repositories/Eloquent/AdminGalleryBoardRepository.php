...
class AdminGalleryBoardRepository extends RepositoriesAbstract implements AdminGalleryBoardInterface
{
     public function getAdminGalleryBoard($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('AdminGalleryBoard_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedAdminGalleryBoard(int $projectId, int $limit = 4, array $with = [])
     {
