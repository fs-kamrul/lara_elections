...
class AdminFacilityRepository extends RepositoriesAbstract implements AdminFacilityInterface
{
     public function getAdminFacility($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('AdminFacility_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedAdminFacility(int $projectId, int $limit = 4, array $with = [])
     {
