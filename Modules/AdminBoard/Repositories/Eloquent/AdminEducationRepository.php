...
class AdminEducationRepository extends RepositoriesAbstract implements AdminEducationInterface
{
     public function getAdminEducation($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('AdminEducation_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedAdminEducation(int $projectId, int $limit = 4, array $with = [])
     {
