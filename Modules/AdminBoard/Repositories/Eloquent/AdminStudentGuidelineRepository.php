...
class AdminStudentGuidelineRepository extends RepositoriesAbstract implements AdminStudentGuidelineInterface
{
     public function getAdminStudentGuideline($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('AdminStudentGuideline_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedAdminStudentGuideline(int $projectId, int $limit = 4, array $with = [])
     {
