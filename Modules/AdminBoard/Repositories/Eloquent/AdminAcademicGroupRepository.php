...
class AdminAcademicGroupRepository extends RepositoriesAbstract implements AdminAcademicGroupInterface
{
     public function getAdminAcademicGroup($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('AdminAcademicGroup_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedAdminAcademicGroup(int $projectId, int $limit = 4, array $with = [])
     {
