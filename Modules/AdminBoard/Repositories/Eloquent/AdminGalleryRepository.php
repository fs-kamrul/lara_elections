...
class AdminGalleryRepository extends RepositoriesAbstract implements AdminGalleryInterface
{
     public function getAdminGallery($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('AdminGallery_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedAdminGallery(int $projectId, int $limit = 4, array $with = [])
     {
