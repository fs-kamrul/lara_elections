...
class AdminTypeRepository extends RepositoriesAbstract implements AdminTypeInterface
{

    public function getAdminTypeBoard($filters = [], $params = [])
    {
        $filters = array_merge([
            'keyword' => null,
            'min_floor' => null,
        ...
        $this->model = apply_filters('AdminType_filter_query', $this->model, $filters, $params);

        return $this->advancedGet($params);
    }
     public function getAdminType($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
     ...
     public function getRelatedAdminType(int $projectId, int $limit = 4, array $with = [])
     {
