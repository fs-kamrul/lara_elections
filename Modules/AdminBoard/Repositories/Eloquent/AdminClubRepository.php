...
class AdminClubRepository extends RepositoriesAbstract implements AdminClubInterface
{

    public function getAdminClubGroup($filters = [], $params = [])
    {
        $filters = array_merge([
            'keyword' => null,
            'min_floor' => null,
        ...
        $this->model = apply_filters('AdminClub_filter_query', $this->model, $filters, $params);

        return $this->advancedGet($params);
    }
     public function getAdminClub($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
     ...
     public function getRelatedAdminClub(int $projectId, int $limit = 4, array $with = [])
     {
