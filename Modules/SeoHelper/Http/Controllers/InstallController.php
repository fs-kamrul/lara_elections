...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'SeoHelper';
        $this->appVersion = config('seohelper.module_version');
        $this->appType = config('seohelper.module_type');
    ...
    public function index()
    {
        ...
        $output = ['status' => 1,
                    'message' => 'SeoHelper module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    private function installSettings()
    {
        ...
        Artisan::call('module:migrate', ['module' => "SeoHelper"]);
        Artisan::call('module:seed', ['module' => "SeoHelper"]);
//        Artisan::call('module:enable', ['module' => "SeoHelper"]);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'SeoHelper module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
//            Artisan::call('module:disable', ['module' => "SeoHelper"]);
            Artisan::call('optimize');
