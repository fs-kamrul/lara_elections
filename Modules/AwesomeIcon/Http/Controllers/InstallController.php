...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'AwesomeIcon';
        $this->appVersion = config('awesomeicon.module_version');
        $this->appType = config('awesomeicon.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "AwesomeIcon"]);
            Artisan::call('module:seed', ['module' => "AwesomeIcon"]);
            Artisan::call('module:enable', ['module' => "AwesomeIcon"]);
        ...
        $output = ['status' => 1,
                    'message' => 'AwesomeIcon module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'AwesomeIcon module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "AwesomeIcon"]);
            Artisan::call('optimize');
