...
namespace Modules\AwesomeIcon\Tables;
...
class AwesomeIconTable extends TableAbstract
{
    /**
     * @var bool
     */
    ...
    /**
     * AwesomeIconTable constructor.
     * @param DataTables $table
     * @param UrlGenerator $urlGenerator
     * @param AwesomeIconInterface $awesomeiconRepository
     */
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, AwesomeIconInterface $awesomeiconRepository)
    {
        parent::__construct($table, $urlGenerator);

        $this->repository = $awesomeiconRepository;

        if (!Auth::user()->can(['awesomeicon_edit', 'awesomeicon_destroy'])) {
        ...
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                if (! Auth::user()->can('awesomeicon_edit')) {
                    ...
                    $name = Html::link(route('awesomeicon.edit', $item->id), DboardHelper::clean($item->name));
                }
            ...
            ->addColumn('operations', function ($item) {
                return $this->getOperations('awesomeicon.edit', 'awesomeicon.destroy', $item);
            });
    ...
    {
        return $this->addCreateButton(route('awesomeicon.create'), 'awesomeicon_create');
    }

    public function bulkActions(): array
    {
        return $this->addDeleteAction(route('awesomeicon.deletes'), 'awesomeicon_destroy', parent::bulkActions());
    }
