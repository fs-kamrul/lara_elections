...
class InstallController  extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->appVersion = config('captcha.module_version');
        $this->appType = config('captcha.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Captcha"]);
            Artisan::call('module:seed', ['module' => "Captcha"]);
            Artisan::call('module:enable', ['module' => "Captcha"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Captcha module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Captcha module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Captcha"]);
            Artisan::call('optimize');
