...
class CaptchaV3 extends CaptchaContract
{
    ...
    public function display(array $attributes = ['action' => 'form'], array $options = [])
    {
        ...
        add_filter(THEME_FRONT_FOOTER, function ($html) use ($isRendered, $uniqueId, $action): string {
            ...
            return $html . view('captcha::v3.script', [
        ...
        return view('captcha::v3.html', compact('name', 'uniqueId'))->render();
    }
}
