    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#user').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('kamruldashboard/api/user') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('user::lang.user')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('kamruldashboard::lang.user')</h4>
                @if(auth()->user()->can('user_import'))
                    <a href="{{ url('kamruldashboard/user/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('kamruldashboard::lang.user_import')</a>
                @endif
                @if(auth()->user()->can('user_create'))
                    <a href="{{ url('kamruldashboard/user/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('kamruldashboard::lang.user_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="user" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
                            <th>@lang('kamruldashboard::lang.id')</th>
                            <th>@lang('kamruldashboard::lang.photo')</th>
                            <th>@lang('kamruldashboard::lang.name')</th>
                            <th>@lang('kamruldashboard::lang.role')</th>
                            <th>@lang('kamruldashboard::lang.status')</th>
