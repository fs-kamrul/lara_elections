    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('kamruldashboard::lang.user_show')</h4>
...
<!--                            </thead>-->
                        ...
                        <tr>
                            <td><b>@lang('kamruldashboard::lang.email')</b></td>
                            <td>{{ $user->email }}</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php
                                $photo_path = '../../uploads/kamruldashboard/user/';
                                if($user->photo == ''){
                                    $photo = 'vendor/kamruldashboard/images/image-not-found.jpg';
                                }else{
                                    $photo = $photo_path . $user->photo;
                                }
                                echo '<img style="height: 100px;width: 100px;" src="' . url($photo) . '" alt="' . $user->photo . '" class="img-rounded img-preview">';
                                ?>
                            </td>
                        </tr>
                        <tr>
                            <td><b>@lang('kamruldashboard::lang.role')</b></td>
