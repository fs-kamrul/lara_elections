    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#role').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('kamruldashboard/api/role') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('role::lang.role')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('kamruldashboard::lang.role')</h4>
                @if(auth()->user()->can('role_import'))
{{--                <a href="{{ url('kamruldashboard/role/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('kamruldashboard::lang.role_import')</a>--}}
                @endif
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="role" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
