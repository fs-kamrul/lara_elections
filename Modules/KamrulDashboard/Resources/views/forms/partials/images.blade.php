...
{{--            <img src="{{ RvMedia::getDefaultImage(false) }}" alt="{{ trans('kamruldashboard::lang.image') }}" width="120">--}}
            <br>
            <p style="color:#c3cfd8">{{ trans('kamruldashboard::lang.using_button') }}
                <strong>{{ trans('kamruldashboard::lang.select_image') }}</strong> {{ trans('kamruldashboard::lang.to_add_more_image') }}.</p>
        </div>
                        ...
                        <li class="gallery-image-item-handler">
                                ...
                                <ul class="photo-overlay-actions">
                                    <li>
                                        <a class="mr10 btn-trigger-edit-gallery-image" data-bs-toggle="tooltip"
                                           data-placement="bottom" data-bs-original-title="{{ trans('kamruldashboard::lang.change_image') }}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="mr10 btn-trigger-remove-gallery-image" data-bs-toggle="tooltip"
                                           data-placement="bottom" data-bs-original-title="{{ trans('kamruldashboard::lang.delete_image') }}">
                            ...
                            <div class="custom-image-box image-box">
                                <input type="hidden" name="{{ $name }}" value="{{ $image }}" class="image-data">
                                    ...
                                    <img src="{{ getImageUrl($image, Arr::get($attributes, 'allow_thumb', true) == true ? 'shortcodes' : null) }}" alt="{{ trans('kamruldashboard::lang.preview_image') }}"
                                         class="preview_image">
                                </div>
                            </div>
                        </li>
    ...
    <a href="#" class="add-new-gallery-image js-btn-trigger-add-image"
       data-name="{{ $name }}">{{ trans('kamruldashboard::lang.add_image') }}
    </a>
</div>
                ...
                <ul class="photo-overlay-actions">
                    <li>
                        <a class="mr10 btn-trigger-edit-gallery-image" data-bs-toggle="tooltip" data-placement="bottom"
                           data-bs-original-title="{{ trans('kamruldashboard::lang.change_image') }}">
                            <i class="fa fa-edit"></i>
                        </a>
                    </li>
                    <li>
                        <a class="mr10 btn-trigger-remove-gallery-image" data-bs-toggle="tooltip" data-placement="bottom"
                           data-bs-original-title="{{ trans('kamruldashboard::lang.delete_image') }}">
                            <i class="fa fa-trash"></i>
                        </a>
                    </li>
                </ul>
...
{{--                <img src="{{ RvMedia::getDefaultImage(false) }}" alt="{{ trans('kamruldashboard::lang.preview_image') }}" class="preview_image">--}}
