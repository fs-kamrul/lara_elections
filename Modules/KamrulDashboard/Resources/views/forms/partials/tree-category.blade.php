...
//    dd($editRoute);
//
    $currentCategories = $categories->where('parent_id', $parentId = $parentId ?? 0);
//    dd($parentId = $parentId ?? 0);
            ...
            <li class="dd-item" data-id="{{ $category->id }}" data-name="{{ $category->name }}">
                ...
                <div @class(['dd3-content d-flex align-items-center gap-2', 'ps-3' => !$updateTreeRoute])>
                    <div class="d-flex align-items-center gap-1" style="width: 90%;">
                        <x-kamruldashboard::icon :name="$hasChildren ? 'ti ti-folder' : 'ti ti-file'" />
                        <span
                        ...
                        @if ($canDelete)
                            ...
                            <x-kamruldashboard::button
                                ...
                                icon="ti ti-trash"
                                :icon-only="true"
                                :tooltip="trans('kamruldashboard::tree-category.delete_button')"
                ...
                @if ($hasChildren)
                    @include('kamruldashboard::forms.partials.tree-category', [
