...
<div {{ $attributes->merge(['class' => "image-box image-box-$name"]) }}>
        ...
        <div class="preview-image-inner">
            ...
            >
                <x-kamruldashboard::image
                    ...
                    alt="{{ trans('kamruldashboard::lang.preview_image') }}"
                />
            ...
            <x-kamruldashboard::button
                ...
                icon="ti ti-x"
                :icon-only="true"
                :tooltip="trans('kamruldashboard::forms.remove_image')"
            />
        </div>
    </div>
    ...
    @if($allowAddFromUrl)
        <div data-bb-toggle="upload-from-url">
            <span class="text-muted">{{ trans('kamruldashboard/media::media.or') }}</span>
            <a
            ...
            >
                {{ trans('kamruldashboard/media::media.add_from_url') }}
            </a>
        </div>
    @endif
</div>
