@props(['name', 'allowThumb' => true, 'images' => [], 'addImagesLabel' => trans('kamruldashboard::forms.add_images'), 'resetLabel' => trans('kamruldashboard::forms.reset')])
    ...
    <div class="images-wrapper mb-2">
        ...
        >
            ...
            <p class="mb-0 text-body">
                {{ trans('kamruldashboard::lang.click_here') }}
                {{ trans('kamruldashboard::lang.to_add_more_image') }}.
            </p>
        </div>
        <input
            name="{{ $name }}"
