...
class PendingRequest {
    ...
    withButtonLoading(element) {
        this.beforeSend(() => kamruldashboard.showButtonLoading(element))
        this.completed(() => kamruldashboard.hideButtonLoading(element))

        return this
    }

    withLoading(element) {
        this.beforeSend(() => kamruldashboard.showLoading(element))
        this.completed(() => kamruldashboard.hideLoading(element))
