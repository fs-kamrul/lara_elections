...
class CurrencySeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            [ "id" => "141", "country" => "Bahrain", "currency" => "Bahraini dinar", "code" => "BHD", "symbol" => "BD", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ]

        ];

//        Currency::insert($data);
        Currency::upsert($data, ['country']);
