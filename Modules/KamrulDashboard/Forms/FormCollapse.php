...
class FormCollapse
{
    ...
    protected $targetFieldType = OnOffCheckboxField::class;

    protected $targetFieldOption = [];

    protected $targetFieldModify = false;

    protected $targetFieldValue = '1';

    protected $fieldsetCallback = [];

    protected $beforeRegisterFieldset = null;

    protected $afterRegisterFieldset = null;
    ...
    public function targetValue($targetValue)
    {
    ...
    public function isOpened(bool $isOpened = true)
    {
    ...
    public function beforeRegisterField(Closure $callback)
    {
    ...
    public function afterRegisterField(Closure $callback)
    {
