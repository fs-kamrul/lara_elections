...
//        dd($this->getDashedNamespace());
    ...
    public function publishAssets($path = null): self
    {
        if ($this->app->runningInConsole()) {
            ...
            $this->publishes([$this->getAssetsPath() => public_path($path)], 'kamrul-public');
        }
    ...
    {
        //base_path('/') .
        Helper::autoload( base_path() . '/' . $this->getDashedNamespace() . '/Http/helpers');
