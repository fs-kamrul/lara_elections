...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'KamrulDashboard';
        $this->appVersion = config('kamruldashboard.module_version');
        $this->appType = config('kamruldashboard.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "KamrulDashboard"]);
            Artisan::call('module:seed', ['module' => "KamrulDashboard"]);
        ...
        $output = ['status' => 1,
                    'message' => 'KamrulDashboard module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'KamrulDashboard module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
