...
/***/ "./Resources/assets/js/utilities/http-client.js":
/*!******************************************************!*\
  !*** ./Resources/assets/js/utilities/http-client.js ***!
  \******************************************************/
...
/* harmony export */ });
/* harmony import */ var _pending_request__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pending-request */ "./Resources/assets/js/utilities/pending-request.js");
...
/***/ "./Resources/assets/js/utilities/index.js":
/*!************************************************!*\
  !*** ./Resources/assets/js/utilities/index.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _http_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./http-client */ "./Resources/assets/js/utilities/http-client.js");


/***/ }),

/***/ "./Resources/assets/js/utilities/pending-request.js":
/*!**********************************************************!*\
  !*** ./Resources/assets/js/utilities/pending-request.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  _createClass(PendingRequest, [{
    ...
    value: function withButtonLoading(element) {
      this.beforeSend(function () {
        return kamruldashboard.showButtonLoading(element);
      });
      this.completed(function () {
        return kamruldashboard.hideButtonLoading(element);
      });
      return this;
    }
  }, {
    ...
    value: function withLoading(element) {
      this.beforeSend(function () {
        return kamruldashboard.showLoading(element);
      });
      this.completed(function () {
        return kamruldashboard.hideLoading(element);
      });
      return this;
    }
  }, {
    ...
    value: function withDefaultErrorHandler() {
      this.errorHandlerUsing(function (error) {
        ...
        switch (statusCode) {
          case 419:
            kamruldashboard.showError('Session expired this page will reload in 5s.');
            setTimeout(function () {
...
"use strict";
/*!**********************************************!*\
  !*** ./Resources/assets/js/tree-category.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utilities */ "./Resources/assets/js/utilities/index.js");
...
$(function () {
  ...
  function fetchData(url, $el) {
    ...
    $httpClient.make().get(url).then(function (_ref2) {
      ...
      return kamruldashboard.hideLoading($formLoading);
    });
  }
  ...
  $(document).on('show.modal', '.modal-confirm-delete', function (event) {
