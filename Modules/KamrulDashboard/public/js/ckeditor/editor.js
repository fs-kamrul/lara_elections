import CKEditorUploadAdapter from './ckeditor-upload-adapter.js';
...
class EditorManagement {
    ...
    getShortcodesAvailable(editor) {
        // console.log('Add getShortcodesAvailable');
        const $dropdown = $(editor).parents('.list-shortcode-items').find('.add_shortcode_btn_trigger')?.next('.dropdown-menu');
        // console.log(editor);
