...
namespace Modules\KamrulDashboard\Packages\Supports\Chunks\Storage;

use Illuminate\Support\Facades\Storage;
use Modules\KamrulDashboard\Packages\Supports\Chunks\ChunkFile;
use Closure;
...
class ChunkStorage
{
    ...
    {
//        dd('ChunkStorage');
        $this->config = DboardMedia::getConfig('chunk');
