...
trait RenderingExtensible
{
    ...
    public static function beforeRendering(callable $callback, int $priority = 100): void
    {
    ...
    public static function afterRendering(callable $callback, int $priority = 100): void
    {
        if (static::hasGlobalRendering() && static::class === static::getGlobalClassName()) {
