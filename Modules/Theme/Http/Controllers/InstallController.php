...
class InstallController  extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->appVersion = config('theme.module_version');
        $this->appType = config('theme.module_type');
    ...
    public function index()
    {
        ...
        $output = ['status' => 1,
                    'message' => 'Theme module installed successfully'
                ];
...
//            Artisan::call('module:migrate', ['module' => "Theme"]);
        Artisan::call('module:seed', ['module' => "Theme"]);
        Artisan::call('module:enable', ['module' => "Theme"]);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Theme module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
