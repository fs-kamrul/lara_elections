...
class AdminBar
{
    ...
    public function __construct()
    {
        $this->groups = [
            'appearance' => [
                'link'  => 'javascript:;',
                'title' => trans('theme::theme.appearance'),
                'items' => [
                    trans('theme::layouts.dashboard') => route('dashboard.index'),
                    trans('theme::setting.title')  => route('theme.options'),
                ],
            ],
            'add-new'    => [
                'link'  => 'javascript:;',
                'title' => trans('theme::theme.add_new'),
                'items' => [
                    trans('theme::users.users') => url('kamruldashboard/user/create'),
                ],
            ],
        ];
    }
