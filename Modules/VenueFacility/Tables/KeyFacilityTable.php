...
class KeyFacilityTable extends TableAbstract
{
    /**
     * @var bool
     */
    ...
    /**
     * KeyFacilityTable constructor.
     * @param DataTables $table
     * @param UrlGenerator $urlGenerator
     * @param KeyFacilityInterface $keyfacilityRepository
     */
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, KeyFacilityInterface $keyfacilityRepository)
    {
        parent::__construct($table, $urlGenerator);

        $this->repository = $keyfacilityRepository;

        if (!Auth::user()->can(['keyfacility_edit', 'keyfacility_destroy'])) {
        ...
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                if (! Auth::user()->can('keyfacility_edit')) {
                    ...
                    $name = Html::link(route('keyfacility.edit', $item->id), DboardHelper::clean($item->name));
                }
            ...
            ->addColumn('operations', function ($item) {
                return $this->getOperations('keyfacility.edit', 'keyfacility.destroy', $item);
            });
    ...
    {
        return $this->addCreateButton(route('keyfacility.create'), 'keyfacility_create');
    }

    public function bulkActions(): array
    {
        return $this->addDeleteAction(route('keyfacility.deletes'), 'keyfacility_destroy', parent::bulkActions());
    }
