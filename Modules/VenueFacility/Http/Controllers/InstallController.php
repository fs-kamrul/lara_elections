...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'VenueFacility';
        $this->appVersion = config('venuefacility.module_version');
        $this->appType = config('venuefacility.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "VenueFacility"]);
            Artisan::call('module:seed', ['module' => "VenueFacility"]);
            Artisan::call('module:enable', ['module' => "VenueFacility"]);
        ...
        $output = ['status' => 1,
                    'message' => 'VenueFacility module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'VenueFacility module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "VenueFacility"]);
            Artisan::call('optimize');
