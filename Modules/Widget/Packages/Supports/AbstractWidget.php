...
namespace Modules\Widget\Packages\Supports;
...
abstract class AbstractWidget
{
    ...
    public function run()
    {
        $widgetGroup = app('kamruldashboard.widget-group-collection');
        $widgetGroup->load();
        ...
        if (!empty($data)) {
            $data_set = (array)json_decode($data->data);
            $this->config = array_merge($this->config, $data_set);
        }
