...
class InstallController  extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->appVersion = config('widget.module_version');
        $this->appType = config('widget.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Widget"]);
            Artisan::call('module:seed', ['module' => "Widget"]);
            Artisan::call('module:enable', ['module' => "Widget"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Widget module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Widget module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Widget"]);
            Artisan::call('optimize');
