...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'Assets';
        $this->appVersion = config('assets.module_version');
        $this->appType = config('assets.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:seed', ['module' => "Assets"]);
            Artisan::call('module:enable', ['module' => "Assets"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Assets module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Assets module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Assets"]);
            Artisan::call('optimize');
