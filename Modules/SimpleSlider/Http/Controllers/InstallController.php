...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'SimpleSlider';
        $this->appVersion = config('simpleslider.module_version');
        $this->appType = config('simpleslider.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "SimpleSlider"]);
            Artisan::call('module:seed', ['module' => "SimpleSlider"]);
            Artisan::call('module:enable', ['module' => "SimpleSlider"]);
        ...
        $output = ['status' => 1,
                    'message' => 'SimpleSlider module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'SimpleSlider module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "SimpleSlider"]);
            Artisan::call('optimize');
