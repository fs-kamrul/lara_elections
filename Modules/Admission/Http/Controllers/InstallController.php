...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'Admission';
        $this->appVersion = config('admission.module_version');
        $this->appType = config('admission.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Admission"]);
            Artisan::call('module:seed', ['module' => "Admission"]);
            Artisan::call('module:enable', ['module' => "Admission"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Admission module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Admission module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Admission"]);
            Artisan::call('optimize');
