...
class ElectionRepository extends RepositoriesAbstract implements ElectionInterface
{
     public function getElection($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('Election_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedElection(int $projectId, int $limit = 4, array $with = [])
     {
