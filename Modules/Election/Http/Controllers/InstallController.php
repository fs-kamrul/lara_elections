...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'Election';
        $this->appVersion = config('election.module_version');
        $this->appType = config('election.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Election"]);
            Artisan::call('module:seed', ['module' => "Election"]);
            Artisan::call('module:enable', ['module' => "Election"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Election module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Election module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Election"]);
            Artisan::call('optimize');
