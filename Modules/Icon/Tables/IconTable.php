...
class IconTable extends TableAbstract
{
    ...
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, IconInterface $iconRepository)
    {
        ...
        if (!Auth::user()->can(['icon_edit', 'icon_destroy'])) {
        ...
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                if (! Auth::user()->can('icon_edit')) {
                    ...
                    $name = Html::link(route('icon.edit', $item->id), DboardHelper::clean($item->name));
                }
    ...
    {
        return $this->addCreateButton(route('icon.create'), 'icon_create');
    }

    public function bulkActions(): array
    {
        return $this->addDeleteAction(route('icon.deletes'), 'icon_destroy', parent::bulkActions());
    }
