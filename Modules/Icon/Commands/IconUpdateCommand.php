...
namespace Modules\Icon\Commands;

use Modules\Menus\Packages\Icon\Facades\Icon;
...
#[AsCommand(name: 'kamrul:icons:update', description: 'Update icons from Tabler Icons')]
