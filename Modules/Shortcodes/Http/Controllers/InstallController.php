...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'Shortcodes';
        $this->appVersion = config('shortcodes.module_version');
        $this->appType = config('shortcodes.module_type');
    ...
    public function index()
    {
        ...
        $output = ['status' => 1,
                    'message' => 'Shortcodes module installed successfully'
                ];
...
//            Artisan::call('module:migrate', ['module' => "Shortcodes"]);
//            Artisan::call('module:seed', ['module' => "Shortcodes"]);
//            Artisan::call('module:enable', ['module' => "Shortcodes"]);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Shortcodes module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
//            Artisan::call('module:disable', ['module' => "$this->module_name"]);
            Artisan::call('optimize');
