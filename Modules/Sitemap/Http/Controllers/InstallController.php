...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'Sitemap';
        $this->appVersion = config('sitemap.module_version');
        $this->appType = config('sitemap.module_type');
    ...
    public function index()
    {
        ...
        $output = ['status' => 1,
                    'message' => 'Sitemap module installed successfully'
                ];
...
//            Artisan::call('module:migrate', ['module' => "Sitemap"]);
//            Artisan::call('module:seed', ['module' => "Sitemap"]);
//        Artisan::call('module:enable', ['module' => "Sitemap"]);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Sitemap module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
//            Artisan::call('module:disable', ['module' => "Sitemap"]);
            Artisan::call('optimize');
