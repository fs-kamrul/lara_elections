...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'ThemeIcon';
        $this->appVersion = config('themeicon.module_version');
        $this->appType = config('themeicon.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "ThemeIcon"]);
            Artisan::call('module:seed', ['module' => "ThemeIcon"]);
            Artisan::call('module:enable', ['module' => "ThemeIcon"]);
        ...
        $output = ['status' => 1,
                    'message' => 'ThemeIcon module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'ThemeIcon module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "ThemeIcon"]);
            Artisan::call('optimize');
