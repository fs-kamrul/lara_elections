...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'ContactForm';
        $this->appVersion = config('contactform.module_version');
        $this->appType = config('contactform.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "ContactForm"]);
            Artisan::call('module:seed', ['module' => "ContactForm"]);
            Artisan::call('module:enable', ['module' => "ContactForm"]);
        ...
        $output = ['status' => 1,
                    'message' => 'ContactForm module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'ContactForm module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "ContactForm"]);
            Artisan::call('optimize');
