...
class InstallController  extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->appVersion = config('location.module_version');
        $this->appType = config('location.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Location"]);
            Artisan::call('module:seed', ['module' => "Location"]);
            Artisan::call('module:enable', ['module' => "Location"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Location module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Location module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Location"]);
            Artisan::call('optimize');
