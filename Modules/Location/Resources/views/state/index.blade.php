...
{{--                    <h4 class="card-title">@lang('state::lang.state')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('location::lang.state')</h4>
                @if(auth()->user()->can('state_import'))
                    <a href="{{ url('location/state/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('location::lang.state_import')</a>
                @endif
                @if(auth()->user()->can('state_create'))
                    <a href="{{ url('location/state/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('location::lang.state_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="state" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
