...
{{--                    <h4 class="card-title">@lang('city::lang.city')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('location::lang.city')</h4>
                @if(auth()->user()->can('city_import'))
                    <a href="{{ url('location/city/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('location::lang.city_import')</a>
                @endif
                @if(auth()->user()->can('city_create'))
                    <a href="{{ url('location/city/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('location::lang.city_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="city" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
