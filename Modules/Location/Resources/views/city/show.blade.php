    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('location::lang.city_show')</h4>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-responsive-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                echo '<img style="height: 100px;width: 100px;" src="' . getImageUrl($row->photo,'location/city') . '" alt="' . $city->name . '" class="img-rounded img-preview">';
                                ?>
                            </td>
                        </tr>
                        <tr>
