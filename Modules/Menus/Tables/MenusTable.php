...
namespace Modules\Menus\Tables;
...
class MenusTable extends TableAbstract
{
    ...
    /**
     * MenusTable constructor.
     * @param DataTables $table
     * @param UrlGenerator $urlGenerator
     * @param MenusInterface $menusRepository
     */
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, MenusInterface $menusRepository)
    {
        parent::__construct($table, $urlGenerator);

        $this->repository = $menusRepository;

        if (!Auth::user()->can(['menus_edit', 'menus_destroy'])) {
        ...
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                if (! Auth::user()->can('menus_edit')) {
                    ...
                    $name = Html::link(route('menus.edit', $item->id), DboardHelper::clean($item->name));
                }
    ...
    {
        return $this->addCreateButton(route('menus.create'), 'menus_create');
    }

    public function bulkActions(): array
    {
        return $this->addDeleteAction(route('menus.deletes'), 'menus_destroy', parent::bulkActions());
    }
