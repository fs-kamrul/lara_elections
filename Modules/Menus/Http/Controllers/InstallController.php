...
class InstallController  extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->appVersion = config('menus.module_version');
        $this->appType = config('menus.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Menus"]);
            Artisan::call('module:seed', ['module' => "Menus"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Menus module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Menus module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
