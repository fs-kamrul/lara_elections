...
class RemoveUnusedTranslationsCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'kamrul:translations:remove-unused-translations';
    ...
    public function handle()
    {
        ...
        foreach (File::directories(resource_path('lang/vendor')) as $package) {
//            if (!File::isDirectory(module_path(File::basename($package)))) {
