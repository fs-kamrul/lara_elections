...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'Translation';
        $this->appVersion = config('translation.module_version');
        $this->appType = config('translation.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Translation"]);
            Artisan::call('module:seed', ['module' => "Translation"]);
            Artisan::call('module:enable', ['module' => "Translation"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Translation module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Translation module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Translation"]);
            Artisan::call('optimize');
