...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'SocialLogin';
        $this->appVersion = config('sociallogin.module_version');
        $this->appType = config('sociallogin.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "SocialLogin"]);
            Artisan::call('module:seed', ['module' => "SocialLogin"]);
            Artisan::call('module:enable', ['module' => "SocialLogin"]);
        ...
        $output = ['status' => 1,
                    'message' => 'SocialLogin module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'SocialLogin module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "SocialLogin"]);
            Artisan::call('optimize');
