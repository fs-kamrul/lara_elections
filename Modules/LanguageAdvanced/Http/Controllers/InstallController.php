...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'LanguageAdvanced';
        $this->appVersion = config('languageadvanced.module_version');
        $this->appType = config('languageadvanced.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "LanguageAdvanced"]);
            Artisan::call('module:seed', ['module' => "LanguageAdvanced"]);
            Artisan::call('module:enable', ['module' => "LanguageAdvanced"]);
        ...
        $output = ['status' => 1,
                    'message' => 'LanguageAdvanced module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'LanguageAdvanced module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "LanguageAdvanced"]);
            Artisan::call('optimize');
