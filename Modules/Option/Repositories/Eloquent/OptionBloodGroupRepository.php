...
class OptionBloodGroupRepository extends RepositoriesAbstract implements OptionBloodGroupInterface
{
     public function getOptionBloodGroup($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('OptionBloodGroup_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedOptionBloodGroup(int $projectId, int $limit = 4, array $with = [])
     {
