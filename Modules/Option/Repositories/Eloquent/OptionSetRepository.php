...
class OptionSetRepository extends RepositoriesAbstract implements OptionSetInterface
{
     public function getOptionSet($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('OptionSet_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedOptionSet(int $projectId, int $limit = 4, array $with = [])
     {
