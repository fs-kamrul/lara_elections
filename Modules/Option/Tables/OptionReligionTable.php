...
class OptionReligionTable extends TableAbstract
{
    /**
     * @var bool
     */
    ...
    /**
     * OptionReligionTable constructor.
     * @param DataTables $table
     * @param UrlGenerator $urlGenerator
     * @param OptionReligionInterface $optionreligionRepository
     */
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, OptionReligionInterface $optionreligionRepository)
    {
        parent::__construct($table, $urlGenerator);

        $this->repository = $optionreligionRepository;

        if (!Auth::user()->can(['optionreligion_edit', 'optionreligion_destroy'])) {
        ...
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                if (! Auth::user()->can('optionreligion_edit')) {
                    ...
                    $name = Html::link(route('optionreligion.edit', $item->id), DboardHelper::clean($item->name));
                }

                return $name;
            })
            ->editColumn('photo', function ($item) {
                $photo_path = 'optionreligion';
            ...
            ->addColumn('operations', function ($item) {
                return $this->getOperations('optionreligion.edit', 'optionreligion.destroy', $item);
            });
    ...
    {
        return $this->addCreateButton(route('optionreligion.create'), 'optionreligion_create');
    }

    public function bulkActions(): array
    {
        return $this->addDeleteAction(route('optionreligion.deletes'), 'optionreligion_destroy', parent::bulkActions());
    }
