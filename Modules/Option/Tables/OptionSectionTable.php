...
class OptionSectionTable extends TableAbstract
{
    /**
     * @var bool
     */
    ...
    /**
     * OptionSectionTable constructor.
     * @param DataTables $table
     * @param UrlGenerator $urlGenerator
     * @param OptionSectionInterface $optionsectionRepository
     */
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, OptionSectionInterface $optionsectionRepository)
    {
        parent::__construct($table, $urlGenerator);

        $this->repository = $optionsectionRepository;

        if (!Auth::user()->can(['optionsection_edit', 'optionsection_destroy'])) {
        ...
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                if (! Auth::user()->can('optionsection_edit')) {
                    ...
                    $name = Html::link(route('optionsection.edit', $item->id), DboardHelper::clean($item->name));
                }

                return $name;
            })
            ->editColumn('photo', function ($item) {
                $photo_path = 'optionsection';
            ...
            ->addColumn('operations', function ($item) {
                return $this->getOperations('optionsection.edit', 'optionsection.destroy', $item);
            });
    ...
    {
        return $this->addCreateButton(route('optionsection.create'), 'optionsection_create');
    }

    public function bulkActions(): array
    {
        return $this->addDeleteAction(route('optionsection.deletes'), 'optionsection_destroy', parent::bulkActions());
    }
