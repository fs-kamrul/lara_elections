...
class OptionShiftTable extends TableAbstract
{
    /**
     * @var bool
     */
    ...
    /**
     * OptionShiftTable constructor.
     * @param DataTables $table
     * @param UrlGenerator $urlGenerator
     * @param OptionShiftInterface $optionshiftRepository
     */
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, OptionShiftInterface $optionshiftRepository)
    {
        parent::__construct($table, $urlGenerator);

        $this->repository = $optionshiftRepository;

        if (!Auth::user()->can(['optionshift_edit', 'optionshift_destroy'])) {
        ...
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                if (! Auth::user()->can('optionshift_edit')) {
                    ...
                    $name = Html::link(route('optionshift.edit', $item->id), DboardHelper::clean($item->name));
                }

                return $name;
            })
            ->editColumn('photo', function ($item) {
                $photo_path = 'optionshift';
            ...
            ->addColumn('operations', function ($item) {
                return $this->getOperations('optionshift.edit', 'optionshift.destroy', $item);
            });
    ...
    {
        return $this->addCreateButton(route('optionshift.create'), 'optionshift_create');
    }

    public function bulkActions(): array
    {
        return $this->addDeleteAction(route('optionshift.deletes'), 'optionshift_destroy', parent::bulkActions());
    }
