...
class OptionSubjectTable extends TableAbstract
{
    /**
     * @var bool
     */
    ...
    /**
     * OptionSubjectTable constructor.
     * @param DataTables $table
     * @param UrlGenerator $urlGenerator
     * @param OptionSubjectInterface $optionsubjectRepository
     */
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, OptionSubjectInterface $optionsubjectRepository)
    {
        parent::__construct($table, $urlGenerator);

        $this->repository = $optionsubjectRepository;

        if (!Auth::user()->can(['optionsubject_edit', 'optionsubject_destroy'])) {
        ...
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                if (! Auth::user()->can('optionsubject_edit')) {
                    ...
                    $name = Html::link(route('optionsubject.edit', $item->id), DboardHelper::clean($item->name));
                }

                return $name;
            })
            ->editColumn('photo', function ($item) {
                $photo_path = 'optionsubject';
            ...
            ->addColumn('operations', function ($item) {
                return $this->getOperations('optionsubject.edit', 'optionsubject.destroy', $item);
            });
    ...
    {
        return $this->addCreateButton(route('optionsubject.create'), 'optionsubject_create');
    }

    public function bulkActions(): array
    {
        return $this->addDeleteAction(route('optionsubject.deletes'), 'optionsubject_destroy', parent::bulkActions());
    }
