...
class InstallController  extends Controller
{
    ...
    {
        $this->module_name = 'Option';
        $this->appVersion = config('option.module_version');
        $this->appType = config('option.module_type');
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Option"]);
            Artisan::call('module:seed', ['module' => "Option"]);
            Artisan::call('module:enable', ['module' => "Option"]);
        ...
        $output = ['status' => 1,
                    'message' => 'Option module installed successfully'
                ];
...
//            ->with('response_data', $output);
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['status' => 1,
                        'message' => 'Option module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
...
//            ->with('response_data', $output);
    ...
    {
        try {
            Artisan::call('module:disable', ['module' => "Option"]);
            Artisan::call('optimize');
