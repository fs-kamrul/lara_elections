    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#optionclass').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('option/api/optionclass') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('optionclass::lang.optionclass')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('option::lang.optionclass')</h4>
                @if(auth()->user()->can('optionclass_import'))
                    <a href="{{ url('option/optionclass/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.optionclass_import')</a>
                @endif
                @if(auth()->user()->can('optionclass_create'))
                    <a href="{{ url('option/optionclass/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.optionclass_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="optionclass" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
