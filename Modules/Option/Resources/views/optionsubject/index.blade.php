    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#optionsubject').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('option/api/optionsubject') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('optionsubject::lang.optionsubject')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('option::lang.optionsubject')</h4>
                @if(auth()->user()->can('optionsubject_import'))
                    <a href="{{ url('option/optionsubject/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.optionsubject_import')</a>
                @endif
                @if(auth()->user()->can('optionsubject_create'))
                    <a href="{{ url('option/optionsubject/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.optionsubject_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="optionsubject" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
