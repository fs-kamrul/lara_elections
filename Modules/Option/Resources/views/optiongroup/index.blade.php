    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#optiongroup').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('option/api/optiongroup') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('optiongroup::lang.optiongroup')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('option::lang.optiongroup')</h4>
                @if(auth()->user()->can('optiongroup_import'))
                    <a href="{{ url('option/optiongroup/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.optiongroup_import')</a>
                @endif
                @if(auth()->user()->can('optiongroup_create'))
                    <a href="{{ url('option/optiongroup/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.optiongroup_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="optiongroup" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
