    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#optionshift').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('option/api/optionshift') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('optionshift::lang.optionshift')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('option::lang.optionshift')</h4>
                @if(auth()->user()->can('optionshift_import'))
                    <a href="{{ url('option/optionshift/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.optionshift_import')</a>
                @endif
                @if(auth()->user()->can('optionshift_create'))
                    <a href="{{ url('option/optionshift/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.optionshift_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="optionshift" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
