    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#optionyear').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('option/api/optionyear') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('optionyear::lang.optionyear')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('option::lang.optionyear')</h4>
                @if(auth()->user()->can('optionyear_import'))
                    <a href="{{ url('option/optionyear/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.optionyear_import')</a>
                @endif
                @if(auth()->user()->can('optionyear_create'))
                    <a href="{{ url('option/optionyear/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.optionyear_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="optionyear" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
