...
<div class="card">
    ...
    <div class="card-body">
        <div class="basic-form">
            ...
            $button = 'update';
            @endphp
            <form name="formoptionyear" method="POST" action="{{ url('option/optionyear/store_import', $record->id) }}" novalidate=""  enctype="multipart/form-data">
                {{ method_field("PATCH") }}
                @else
                @php
                $button = 'save';
                @endphp
                <form method="POST" action="{{ url('option/optionyear/store_import') }}"  enctype="multipart/form-data">
                    @endif
                    @csrf
