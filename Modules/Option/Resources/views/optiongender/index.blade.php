    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#optiongender').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('option/api/optiongender') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('optiongender::lang.optiongender')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('option::lang.optiongender')</h4>
                @if(auth()->user()->can('optiongender_import'))
                    <a href="{{ url('option/optiongender/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.optiongender_import')</a>
                @endif
                @if(auth()->user()->can('optiongender_create'))
                    <a href="{{ url('option/optiongender/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.optiongender_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="optiongender" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
