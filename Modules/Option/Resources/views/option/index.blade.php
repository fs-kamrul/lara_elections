...
{{--                    <h4 class="card-title">@lang('option::lang.option')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
        ...
        <div class="card">
            <div class="card-header">
                ...
                @if(auth()->user()->can('option_import'))
                    <a href="{{ url('option/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.option_import')</a>
                @endif
                @if(auth()->user()->can('option_create'))
                    <a href="{{ route('option.create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.option_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="option" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
