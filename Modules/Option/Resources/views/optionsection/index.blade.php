    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#optionsection').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('option/api/optionsection') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('optionsection::lang.optionsection')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('option::lang.optionsection')</h4>
                @if(auth()->user()->can('optionsection_import'))
                    <a href="{{ url('option/optionsection/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.optionsection_import')</a>
                @endif
                @if(auth()->user()->can('optionsection_create'))
                    <a href="{{ url('option/optionsection/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.optionsection_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="optionsection" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
