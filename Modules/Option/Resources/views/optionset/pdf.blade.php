...
Fpdf::Cell($line_width, $line_height, $optionset->name,0,1);
Fpdf::Cell(50, $line_height, 'Status:',0);
Fpdf::Cell($line_width, $line_height, array_status_disign_name($optionset->status),0,1);
if($optionset->description) {
    Fpdf::Cell(50, $line_height, 'Description:', 0);
    Fpdf::TextArea(-1, 10, $line_width, $line_height-7, 0, $optionset->description);
}
Fpdf::Output();
exit();
?>
