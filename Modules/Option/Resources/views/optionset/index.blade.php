...
{{--                    <h4 class="card-title">@lang('optionset::lang.optionset')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('option::lang.optionset')</h4>
                @if(auth()->user()->can('optionset_import'))
                    <a href="{{ url('option/optionset/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.optionset_import')</a>
                @endif
                @if(auth()->user()->can('optionset_create'))
                    <a href="{{ url('option/optionset/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.optionset_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="optionset" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
