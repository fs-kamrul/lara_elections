...
<div class="card">
    ...
    <div class="card-body">
        <div class="basic-form">
            ...
            $button = 'update';
            @endphp
            <form name="formoptionreligion" method="POST" action="{{ url('option/optionreligion/store_import', $record->id) }}" novalidate=""  enctype="multipart/form-data">
                {{ method_field("PATCH") }}
                @else
                @php
                $button = 'save';
                @endphp
                <form method="POST" action="{{ url('option/optionreligion/store_import') }}"  enctype="multipart/form-data">
                    @endif
                    @csrf
