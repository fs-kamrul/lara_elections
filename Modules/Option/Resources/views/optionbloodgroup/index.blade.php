    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#optionbloodgroup').DataTable({
                ...
                processing: true,
                aaSorting: [[0, "desc"]],
                ajax: "{{ url('option/api/optionbloodgroup') }}",
                columns: [
                    {data: 'id', name: 'id'},
...
{{--                    <h4 class="card-title">@lang('optionbloodgroup::lang.optionbloodgroup')</h4>--}}
{{--                </div>--}}
{{--                <div class="card-body">--}}
{{--                    <h1>Hello World</h1>--}}
{{--                </div>--}}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('option::lang.optionbloodgroup')</h4>
                @if(auth()->user()->can('optionbloodgroup_import'))
                    <a href="{{ url('option/optionbloodgroup/import') }}" type="button" class="btn btn-warning"><i class="icon-plus"></i> @lang('option::lang.optionbloodgroup_import')</a>
                @endif
                @if(auth()->user()->can('optionbloodgroup_create'))
                    <a href="{{ url('option/optionbloodgroup/create') }}" type="button" class="btn btn-dark"><i class="icon-plus"></i> @lang('option::lang.optionbloodgroup_create')</a>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="optionbloodgroup" class="display" style="min-width: 845px">
                        <thead>
                        <tr>
