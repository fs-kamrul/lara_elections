...
var MenuNestable = /*#__PURE__*/function () {
  ...
  _createClass(MenuNestable, [{
    ...
    value: function handleNestableMenu() {
      ...
      kamruldashboard.callScroll($('.list-item'));
    }
  }]);
  return MenuNestable;
}();
...
let terminalHighlight = __webpack_require__(/*! ./terminal-highlight */ "?2f35")
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(/*! source-map-js */ "?9c16")
let { fileURLToPath, pathToFileURL } = __webpack_require__(/*! url */ "?ca9c")
let { resolve, isAbsolute } = __webpack_require__(/*! path */ "?c7d4")
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(/*! source-map-js */ "?9c16")
let { dirname, resolve, relative, sep } = __webpack_require__(/*! path */ "?c7d4")
let { pathToFileURL } = __webpack_require__(/*! url */ "?ca9c")
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(/*! source-map-js */ "?9c16")
let { existsSync, readFileSync } = __webpack_require__(/*! fs */ "?aff1")
let { dirname, join } = __webpack_require__(/*! path */ "?c7d4")
...
/******/ 	__webpack_require__.O(undefined, ["public/css/menus"], () => (__webpack_require__("./Resources/assets/js/menu.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/menus"], () => (__webpack_require__("./Resources/assets/sass/menu.scss")))
