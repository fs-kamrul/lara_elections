...
$(document).ready(() => {
    BDashboard.loadWidget($('#widget_analytics_general').find('.widget-content'), analytics_general, null, () => {
        PluginAnalytics.initCharts();
    });
    BDashboard.loadWidget($('#widget_analytics_page').find('.widget-content'), analytics_page);
    BDashboard.loadWidget($('#widget_analytics_browser').find('.widget-content'), analytics_browser);
    BDashboard.loadWidget($('#widget_analytics_referrer').find('.widget-content'), analytics_referrer);
});
