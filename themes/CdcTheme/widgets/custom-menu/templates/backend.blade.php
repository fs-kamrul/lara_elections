...
<div class="form-group">
    ...
    {!! Form::customSelect('menu_id', app(\Modules\Menus\Repositories\Interfaces\MenusInterface::class)->pluck('name', 'slug'), $config['menu_id'], ['class' => 'form-control select-full']) !!}
</div>
