@if (is_module_active('SimpleSlider') && count($sliders) > 0 &&
                                        ...
                                        <div class="container">
                                            <div class="slider-1-height-3 slider-animated-1">
                                                ...
                                                <div class="slider-img">
                                                    <img src="{{ getImageUrlById($slider->image,'shortcodes') }}" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section class="home-slider position-relative mb-30 mt-30">
            <div class="container">
                <div class="home-slide-cover bg-grey-9">
                    {!! Theme::partial('short-codes.sliders.grid', compact('sliders', 'shortcode') + ['class' => 'style-4']) !!}
                </div>
            </div>
        </section>
    ...
    @else
        {!! Theme::partial('short-codes.sliders.grid', compact('sliders', 'shortcode')) !!}
    @endif
@endif
