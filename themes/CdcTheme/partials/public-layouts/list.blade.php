...
{{--                            background-image: url({{ RvMedia::getImageUrl($post->image, 'small', false, RvMedia::getDefaultImage()) }})"--}}
{{--                            <div class="img-hover-slide border-radius-5 position-relative" style=">--}}
