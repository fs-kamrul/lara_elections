...
return [
    ...
    'export_warning'                 => 'Warning, translations are not visible until they are exported back to the resources/lang file, using \'php artisan kamrul:translations:export\' command or publish button.',
